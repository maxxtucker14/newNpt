function [n,x,nbins]=histn(y,bins)
% For multidimensional histograms for Matlab 5.
%
% [n,x,nbins]=histn(y,bins)
%
% Every row in y represent a different data point and the columns
% are the different coordinates.
%
% For 2D data, the first column in y will end up being in the rows of n and
% the second column will be in the cols of n.
%
...
if (size(bins,2)~=size(y,2))
  error('Wrong number of bins in histn');
end;
